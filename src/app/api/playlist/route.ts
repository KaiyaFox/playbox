...
export async function GET() {
    ...
    try {
        ...
        const track = {
            ...
            artist: currentlyPlayingData.item.artists.map((artist: Playlist) => artist.name).join(", "),
            artistId: currentlyPlayingData.item.artists.map((artist: Playlist) => artist.id).join(", "),
